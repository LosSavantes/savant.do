          ...
          <div className="row justify-content-center">
            <div className="col-lg-10 mt-5">
              ...
              <p>
                ...
                Savantes usa y protege la información que es proporcionada por
              ...
              <p>
                ...
                través de nuestro sitio con ofertas especiales, nuevos productos
                y otra información publicitaria que consideremos relevante para
              ...
              <p>
                Savantes está altamente comprometido para cumplir con el
              ...
              <p>
                ...
                directamente, <a href="" target="_blank"></a>. Usted puede
              ...
              <p>
                ...
                sitio web.&nbsp; Cada vez que se le solicite rellenar un
                formulario, como el de alta de usuario, puede marcar o desmarcar
              ...
              <p>
                Savantes Se reserva el derecho de cambiar los términos de la
...
export async function getStaticProps() {
  ...
  const path = require("path").resolve("public/md/privacy.md");
